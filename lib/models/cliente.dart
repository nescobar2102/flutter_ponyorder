...
class Cliente {
  ...
  @override
  String toString() {
    return 'Cliente{id:$id, id_tercero: $id_tercero, id_sucursal_tercero: $id_sucursal_tercero,'
           '  id_tipo_identificacion: $id_tipo_identificacion,  dv: $dv, nombre: $nombre, direccion: $direccion,'
           '  id_pais: $id_pais, id_depto: $id_depto, id_ciudad: $id_ciudad, id_barrio: $id_barrio,telefono: $telefono,'
           '  cliente: $cliente, fecha_creacion: $fecha_creacion,  nombre_sucursal: $nombre_sucursal, primer_apellido: $primer_apellido,'
           '  segundo_apellido: $segundo_apellido, primer_nombre: $primer_nombre,  segundo_nombre: $segundo_nombre, e_mail: $e_mail, nit: $nit,'
           ' id_tipo_empresa: $id_tipo_empresa,id_forma_pago: $id_forma_pago,id_precio_item:$id_precio_item,id_vendedor:$id_vendedor,'
           ' id_suc_vendedor:$id_suc_vendedor,id_medio_contacto:$id_medio_contacto,id_zona:$id_zona}';
  }
}
