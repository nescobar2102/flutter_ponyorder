...
class Units { 
  ...
  @override
  String toString() {
     return 'Units{ id_item: $id_item,descripcion: $descripcion, referencia: $referencia, id_impuesto: $id_impuesto, tipo_impuesto: $tipo_impuesto,'
      'dcto_producto: $dcto_producto,  dcto_maximo: $dcto_maximo, flag_facturable: $flag_facturable, flag_serial: $flag_serial,'
      'flag_kit: $flag_kit, id_clasificacion: $id_clasificacion, id_padre_clasificacion: $id_padre_clasificacion, id_unidad_compra: $id_unidad_compra,'
      'exento_impuesto: $exento_impuesto, flag_existencia: $flag_existencia, flag_dcto_volumen : $flag_dcto_volumen, nit: $nit, saldo_inventario: $saldo_inventario}';
     }
}
