...
class SendataSincronizacion   {
  ...
  static convertDateFormat(fecha) {
    print("la fecha que entra $fecha");
    var info = fecha.split('-');
    var nueva_fecha = info[2]+'/'+info[1]+'/'+info[0];
    ...
    if(data!= false){
      for (int i = 0; i < data.length; i++) {
        final body = {
          ...
          "telefono_celular": data[i]['telefono'].toString(),
     ...
     for (int i = 0; i < data.length; i++) {
      ...
      var success = jsonResponse['success'];
            ...
            if (response.statusCode == 201 && success) {
              ...
              print("se actualizo el pedido $success");
           }
          }
      }
 ...
 static Future<void> sendCartera() async {
    ...
    if(dataDet!= false){
               ...
               for (var j = 0; j < dataDet.length; j++) ...[
                 {
                   ...
                   "fecha": convertDateFormat2(dataDet[j]['fecha'].toString()),
      ...
      print("*-*-*--*-body $body*-*-*-*");
       ...
       print("---resul de la cartera----$msg");
       if (response.statusCode == 201 && success) {
          print("se actualiza flag cartera");
                final body = {
                      'nit': data[i]['nit'],
                      'id_tipo_doc':data[i]['id_tipo_doc'],
                ...
                var success = jsonResponse['success'];
                    ...
                    print("se actualiza la updateReciboFlag $i");
                    }
                }
              }
           }
